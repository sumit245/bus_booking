...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function showRegistrationForm()
    {
        ...
        return view(
            $this->activeTemplate . "user.auth.register",
            compact("pageTitle", "mobile_code", "countries"),
        );
    }

    public function showOtpRegistrationForm()
    {
        $pageTitle = "Sign Up with OTP";
        return view(
            $this->activeTemplate . "user.auth.register_otp",
            compact("pageTitle"),
        );
    }
    ...
    public function register(Request $request)
    {
        ...
        $exist = User::where(
            "mobile",
            $request->mobile_code . $request->mobile,
        )->first();
        if ($exist) {
    ...
    protected function create(array $data)
    {
        ...
        //User Create
        $user = new User();
        $user->firstname = isset($data["firstname"])
            ? $data["firstname"]
            : null;
