                                ...
                                @forelse($layouts as $item)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <button type="button" class="icon-btn ml-1 editBtn" data-toggle="modal"
                                                data-target="#editModal" data-layout="{{ __($item->layout) }}"
                                                data-action="{{ route('admin.fleet.seat.layouts.update', $item->id) }}"
                                                data-original-title="@lang('Update')">
                                                <i class="la la-pen"></i>
                                            </button>

                                            <button type="button" class="icon-btn btn--danger ml-1 removeBtn"
                                                data-toggle="modal" data-target="#removeModal" data-id="{{ $item->id }}"
                ...
                <form action="{{ route('admin.fleet.seat.layouts.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="@lang('2 x 3')" name="layout"
                                required>
