        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">@lang('Add New Bus')</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('operator.buses.store') }}" method="POST" id="busForm">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('travel_name') is-invalid @enderror"
                                        name="travel_name" value="{{ old('travel_name', $defaultTravelName ?? '') }}"
                                        required placeholder="e.g., Kalpana Travels Rewa">
                                    @error('travel_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">@lang('Prefilled with your company name. You can modify if needed.')</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('bus_type') is-invalid @enderror"
                                        name="bus_type" value="{{ old('bus_type') }}" required
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('service_name') is-invalid @enderror"
                                        name="service_name" value="{{ old('service_name', 'Seat Seller') }}"
                                    ...
                                    <select class="form-control @error('current_route_id') is-invalid @enderror"
                                        ...
                                        @foreach ($routes as $route)
                                            <option value="{{ $route->id }}"
                                                {{ old('current_route_id') == $route->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('fuel_type') is-invalid @enderror" name="fuel_type">
                                        <option value="Diesel"
                                            {{ old('fuel_type', 'Diesel') == 'Diesel' ? 'selected' : '' }}>
                                            @lang('Diesel')</option>
                                        <option value="Petrol" {{ old('fuel_type') == 'Petrol' ? 'selected' : '' }}>
                                            @lang('Petrol')</option>
                                        <option value="CNG" {{ old('fuel_type') == 'CNG' ? 'selected' : '' }}>
                                            @lang('CNG')</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        name="available_seats" value="{{ old('available_seats') }}" required
                                        min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        name="max_seats_per_ticket" value="{{ old('max_seats_per_ticket', 6) }}"
                                        min="1" max="20">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('base_price') }}" required min="0" id="base_price">
                                    @error('base_price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="published_price" value="{{ old('published_price') }}" required
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="offered_price" value="{{ old('offered_price') }}" required min="0"
                                        id="offered_price">
                                    @error('offered_price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="agent_commission" value="{{ old('agent_commission') }}" min="0"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="other_charges" value="{{ old('other_charges', 0) }}" min="0"
                                        id="other_charges">
                                    @error('other_charges')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('discount', 0) }}" min="0" id="discount">
                                    @error('discount')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="service_charges" value="{{ old('service_charges', 0) }}" min="0"
                                        id="service_charges">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="cgst_amount" value="{{ old('cgst_amount', 0) }}" min="0"
                                        id="cgst_amount">
                                    @error('cgst_amount')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('cgst_rate', 0) }}" min="0" max="100" id="cgst_rate">
                                    @error('cgst_rate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="igst_amount" value="{{ old('igst_amount', 0) }}" min="0"
                                        id="igst_amount">
                                    @error('igst_amount')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('igst_rate', 0) }}" min="0" max="100" id="igst_rate">
                                    @error('igst_rate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="sgst_amount" value="{{ old('sgst_amount', 0) }}" min="0"
                                        id="sgst_amount">
                                    @error('sgst_amount')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('sgst_rate', 0) }}" min="0" max="100" id="sgst_rate">
                                    @error('sgst_rate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="taxable_amount" value="{{ old('taxable_amount', 0) }}" min="0"
                                        id="taxable_amount">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="is_drop_point_mandatory"
                                            ...
                                            {{ old('is_drop_point_mandatory') ? 'checked' : '' }}>
                                        <label class="custom-control-label"
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="live_tracking_available"
                                            ...
                                            {{ old('live_tracking_available') ? 'checked' : '' }}>
                                        <label class="custom-control-label"
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="m_ticket_enabled"
                                            ...
                                            {{ old('m_ticket_enabled', true) ? 'checked' : '' }}>
                                        <label class="custom-control-label"
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input"
                                            ...
                                            value="1"
                                            {{ old('partial_cancellation_allowed', true) ? 'checked' : '' }}>
                                        <label class="custom-control-label"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        name="manufacturing_year" value="{{ old('manufacturing_year') }}" min="1990"
                                        max="{{ date('Y') + 1 }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="amenity_tv"
                                                    ...
                                                    {{ in_array('TV', old('amenities', [])) ? 'checked' : '' }}>
                                                <label class="custom-control-label"
                                        ...
                                        <div class="col-md-6">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="amenity_charging"
                                                    ...
                                                    {{ in_array('Charging', old('amenities', [])) ? 'checked' : '' }}>
                                                <label class="custom-control-label"
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="amenity_water"
                                                    ...
                                                    {{ in_array('Water', old('amenities', [])) ? 'checked' : '' }}>
                                                <label class="custom-control-label"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="3"
                                        placeholder="@lang('Additional bus details (optional)')">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="permit_number" value="{{ old('permit_number') }}">
                                    @error('permit_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        name="permit_expiry" value="{{ old('permit_expiry') }}">
                                    @error('permit_expiry')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="fitness_certificate" value="{{ old('fitness_certificate') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        name="fitness_expiry" value="{{ old('fitness_expiry') }}">
                        ...
                        <div class="form-group mt-4">
                            <button type="submit" class="btn btn--primary">@lang('Create Bus')</button>
