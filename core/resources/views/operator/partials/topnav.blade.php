        ...
        <ul class="navbar__action-list">
                ...
                <div class="dropdown-menu dropdown-menu--md p-0 border-0 box--shadow1 dropdown-menu-right">
                    ...
                    <div class="dropdown-menu__body">
                        <div class="text-center py-3">
                            <p class="text-muted">@lang('No notifications available')</p>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <li class="dropdown">
                <button type="button" class="" data-toggle="dropdown" data-display="static" aria-haspopup="true"
                    ...
                    <span class="navbar-user">
                        <span class="navbar-user__thumb">
                            <img src="{{ getImage(imagePath()['profile']['operator']['path'] . '/' . auth('operator')->user()->photo, imagePath()['profile']['operator']['size']) }}"
                                alt="image">
                        </span>
                        <span class="navbar-user__info">
                            <span class="navbar-user__name">{{ auth('operator')->user()->name }}</span>
                        </span>
                ...
                <div class="dropdown-menu dropdown-menu--sm p-0 border-0 box--shadow1 dropdown-menu-right">
                    ...
                    <a href="{{ route('operator.change-password') }}"
                        class="dropdown-menu__item d-flex align-items-center px-3 py-2">
