        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">@lang('Edit Route') - {{ $route->display_name }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('operator.routes.update', $route->id) }}" method="POST" id="routeForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('route_name') is-invalid @enderror"
                                        name="route_name" value="{{ old('route_name', $route->route_name) }}" required>
                                    @error('route_name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('distance', $route->distance) }}" placeholder="e.g., 150.5">
                                    @error('distance')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('base_fare', $route->base_fare) }}" placeholder="e.g., 500.00">
                                    @error('base_fare')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="3"
                                        placeholder="@lang('Route description (optional)')">{{ old('description', $route->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <div id="boardingPointsContainer">
                                    @foreach ($route->boardingPoints as $index => $point)
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="boarding_points[{{ $index }}][point_name]"
                                                            value="{{ old("boarding_points.{$index}.point_name", $point->point_name) }}"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="boarding_points[{{ $index }}][point_location]"
                                                            value="{{ old("boarding_points.{$index}.point_location", $point->point_location) }}"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>@lang('Time') <span
                                                                class="text-danger">*</span></label>
                                                        <input type="time" class="form-control"
                                                            name="boarding_points[{{ $index }}][point_time]"
                                                            value="{{ old("boarding_points.{$index}.point_time", $point->point_time ? $point->point_time->format('H:i') : '') }}"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="boarding_points[{{ $index }}][contact_number]"
                                                            value="{{ old("boarding_points.{$index}.contact_number", $point->contact_number) }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>@lang('Address') <span
                                                                class="text-danger">*</span></label>
                                                        <textarea class="form-control" name="boarding_points[{{ $index }}][point_address]" rows="2" required>{{ old("boarding_points.{$index}.point_address", $point->point_address) }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="boarding_points[{{ $index }}][point_landmark]"
                                                            value="{{ old("boarding_points.{$index}.point_landmark", $point->point_landmark) }}">
                                                    </div>
                                                </div>
                                                @if ($index > 0)
                                                    <div class="col-md-12">
                                                        <button type="button" class="btn btn--danger btn-sm"
                                                            onclick="removeBoardingPoint(this)">
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <div id="droppingPointsContainer">
                                    @foreach ($route->droppingPoints as $index => $point)
                                        <div class="dropping-point-item border p-3 mb-3">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>@lang('Point Name') <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" class="form-control"
                                                            name="dropping_points[{{ $index }}][point_name]"
                                                            value="{{ old("dropping_points.{$index}.point_name", $point->point_name) }}"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>@lang('Location') <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" class="form-control"
                                                            name="dropping_points[{{ $index }}][point_location]"
                                                            value="{{ old("dropping_points.{$index}.point_location", $point->point_location) }}"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>@lang('Time') <span
                                                                class="text-danger">*</span></label>
                                                        <input type="time" class="form-control"
                                                            name="dropping_points[{{ $index }}][point_time]"
                                                            value="{{ old("dropping_points.{$index}.point_time", $point->point_time ? $point->point_time->format('H:i') : '') }}"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>@lang('Contact Number')</label>
                                                        <input type="text" class="form-control"
                                                            name="dropping_points[{{ $index }}][contact_number]"
                                                            value="{{ old("dropping_points.{$index}.contact_number", $point->contact_number) }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>@lang('Address')</label>
                                                        <textarea class="form-control" name="dropping_points[{{ $index }}][point_address]" rows="2">{{ old("dropping_points.{$index}.point_address", $point->point_address) }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>@lang('Landmark')</label>
                                                        <input type="text" class="form-control"
                                                            name="dropping_points[{{ $index }}][point_landmark]"
                                                            value="{{ old("dropping_points.{$index}.point_landmark", $point->point_landmark) }}">
                                                    </div>
                                                </div>
                                                @if ($index > 0)
                                                    <div class="col-md-12">
                                                        <button type="button" class="btn btn--danger btn-sm"
                                                            onclick="removeDroppingPoint(this)">
                                                            <i class="la la-trash"></i> @lang('Remove')
                                                        </button>
                                                    </div>
                                                @endif
                        ...
                        <div class="form-group mt-4">
                            <button type="submit" class="btn btn--primary">@lang('Update Route')</button>
