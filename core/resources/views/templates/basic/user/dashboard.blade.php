                    ...
                    <div class="col-lg-3 col-md-6 col-sm-10">
                        <div class="dashboard-widget blue">
                            <div class="dashboard-widget__content">
                                ...
                                <h3 class="title">{{ __($widget['total']) }}</h3>
                            </div>
                ...
                <i class="las la-check-circle"></i>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-10">
                        <div class="dashboard-widget red">
                            <div class="dashboard-widget__content">
                                <p>@lang('Cancelled Tickets')</p>
                                <h3 class="title">{{ __($widget['cancelled']) }}</h3>
                            </div>
                            <div class="dashboard-widget__icon">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-10">
                        <div class="dashboard-widget yellow">
                            <div class="dashboard-widget__content">
                                <p>@lang('Pending Tickets')</p>
                            ...
                            @forelse ($bookedTickets as $item)
                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('Bus Type')">
                                        {{ $item->bus_type ?? ($busDetails['bus_type'] ?? (isset($item->trip->fleetType) && $item->trip->fleetType->has_ac ? 'AC' : 'Non-Ac')) }}
                                    </td>
                                    ...
                                    <td class="time" data-label="Pickup Time">
                                        ...
                                        @elseif($departureTime)
                                            {{ $departureTime }}
                                        @elseif(optional(optional($item->trip)->schedule)->start_from)
                                            {{ __(showDateTime(optional($item->trip->schedule)->start_from, 'H:i a')) }}
                                        @else
                                            N/A
                                        @endif
                                    </td>
...
@push('script')
    <script>
        ...
        $('.checkinfo').on('click', function() {
            ...
            <p class="d-flex flex-wrap justify-content-between"><strong>@lang('Total Amount')</strong>  <span>${parseFloat(info.total_amount || info.sub_total).toFixed(2)} {{ __($general->cur_text) }}</span></p>
